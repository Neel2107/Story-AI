...
const navigation = location.pathname === "/login" || location.pathname === "/" 
  ? [
      { name: 'Login', href: '/login', current: location.pathname === '/login' },
      { name: 'Signup', href: '/', current: location.pathname === '/' },
    ]
  : [
...
export default function Navbar() {
  ...
  useEffect(() => {
    const updateNavigation = () => {
      ...
      const updatedNavigation = isLoginOrSignup
        ? [
            { name: 'Login', href: '/login', current: location.pathname === '/login' },
            { name: 'Signup', href: '/', current: location.pathname === '/' },
          ]
  ...
  return (
    <Disclosure as="nav" className="bg-gray-800 mainNav">
      {({ open }) => (
        <>
